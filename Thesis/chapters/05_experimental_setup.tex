...
This work focuses on Subtask C and all results for the aspect-based sentiment analysis are reported in section \ref{sec:06_ResultsGermEval}.
\newline
...
%TODO: Refer to GermEval F1 Score issues

\begin{table}
	\begin{tabular}{lrrrrrr}
		\hline
		Aspect                       & Test-1 & Test-2 & Train  & Val  & Total  & Ratio   \\ \hline
		...
		Zugfahrt                     & 241    & 184    & 1798   & 190  & 2413   & 9.35\%  \\ \hline
		Total                        & 2467   & 1721   & 19,297 & 2310 & 25,795 & 100\%   \\ \hline
	\end{tabular}
