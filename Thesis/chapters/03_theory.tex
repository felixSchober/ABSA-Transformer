...
Rich Caruana first introduced \acrful{mtl} in 1993. Conventional machine learning approaches break a problem down in smaller tasks and solve one task at a time (e.g., word \gls{pos}-tagging, word \gls{ner}, image classification). Caruana shows that combining multiple related tasks improves model performance \cite{Caruana1993}\cite{Caruana1997a}. 
