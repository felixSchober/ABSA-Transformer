...
\subsection{Transformer Encoder-Decoder Architecture}
...
Decoder 2 uto $n$ now get the encoded input {(as before)} as well as the output of the decoders below. The top encoder will then output "like" as the next token in the sequence. 
