...
\begin{table}[htb]
	\centering
	\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}rccc@{}}
	\toprule
	Variant          & \multicolumn{1}{c}{\textbf{Num Aspects}}& \multicolumn{2}{c}{\textbf{Micro F1}}       \\ 
	\midrule
					   &  		&\textit{dev}		& \textit{test} 		\\
	\midrule

	Entity-Attributes   & 114	&  0.068    		&   0.060				\\ 
	Entities     		& 9		&  0.204    		&   0.164   			\\ 
	Entities 2C    		& 9		&  0.152    		&   0.147   			\\ 
	Attributes    		& 14		&  0.189     		&   0.139   			\\ 
	Coarse    			& 18 	&  0.314    		&   0.255   			\\ 
	\bottomrule
	\multicolumn{5}{c}{\textbf{Organic-2019 - Dataset Partitions}} \\
	\end{tabular*}
