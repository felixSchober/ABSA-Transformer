...
\begin{table}[htb]
	...
	Entity-Attributes   & -         	& -	&  -        		&   -   			\\ 
	Entities     		& -         	& 0.081	&  -        		&   0.187   			\\ 
	Entities 2C    		& -         	& 0.081	&  -        		&   0.187   			\\ 
	Attributes    		& -         	& 0.081	&  -        		&   0.187   			\\ 
	Coarse    			& -         	& 0.081	&  -        		&   0.187   			\\ 
	\bottomrule
	\multicolumn{5}{c}{\textbf{Organic-2019 - Dataset Partitions}} \\
	\end{tabular*}
	\caption{Report of results on different data partitions on the Organic-2019 dataset. Entity-Attributes denotes the full fine-grained combinations of entities and attributes.}
